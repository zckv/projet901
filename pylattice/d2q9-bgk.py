...
class t_param:
    ...
    density: float  # density per link
    accel: float  # density redistribution */
    omega: float # relaxation parameter */


class t_speed:
    """struct to hold the 'speed' values"""
    speeds = [0.0] * NSPEEDS     # List[NSPEEDS];
...
#  inalise, including freeing up allocated memory
...
def main():
    paramfile: str = None #    /* name of the input parameter file */
    obstaclefile:str = None # /* name of a the input obstacle file */
    params t_param #              /* struct to hold parameter values */
    cells: list    = None #  list(tspeed)   /* grid containing fluid densities */
    tmp_cells: list = None # list t_speed ;    /* scratch space */
    obstacles = None # list int    /* grid indicating which cells are blocked */
